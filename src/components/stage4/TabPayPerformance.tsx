...
export default function TabPayPerformance() {
  const crData: BarData[] = [
    ...
    <div className="fade-enter">
      ...
      <div className="insight-card">
        ...
        <div className="insight-text">
          你提到调薪预算 8% 按统一比例分配，这从数据上得到了印证——A 绩效 CR 1.12 vs C 绩效 CR 0.91，差距仅 23%，标杆企业通常 35-50%。建议在 8% 的预算内加大绩效分化，A 级调薪提至 15-20%，C 级控制在 0-3%，拉开差距。
        </div>
      </div>
    </div>
  );
