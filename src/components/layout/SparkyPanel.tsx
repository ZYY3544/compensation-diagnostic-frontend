...
export interface SparkyPanelHandle {
  clearInput: () => void;
}

const SparkyPanel = forwardRef<SparkyPanelHandle, SparkyPanelProps>(
  ({ messages, onSend, showTyping, visible, onClose }, ref) => {
...
SparkyPanel.displayName = 'SparkyPanel';
