...
export default function TabLaborCost() {
  const metrics = [
    ...
    <div className="fade-enter">
      ...
      <div className="insight-card">
        ...
        <div className="insight-text">
          你提到明年的重点是降本增效，数据也显示这很紧迫——人工成本增速（22%）显著高于营收增速（15%），四年成本增长 75%，主要是人员扩张驱动（+48%）。结合你的降本目标，建议控制招聘节奏，同时把有限的调薪预算向销售关键岗位倾斜，而不是撒胡椒面。
        </div>
      </div>
    </div>
  );
